...
fs.readFile(file, function editContent (err, contents) {
  ...
  if ( $('.' + logo_stylename).length ) {
    var logoimg = '<img src="S:/resources/bookmaker_scripts/bookmaker_assets/master/pdfmaker/images/RESOURCEDIR/logo.jpg"></img>';
    $('.' + logo_stylename).empty().append(logoimg);
  } else {
    var logoholder = '<p class="' + logo_stylename + '"><img src="S:/resources/bookmaker_scripts/bookmaker_assets/master/pdfmaker/images/RESOURCEDIR/logo.jpg"/></p>';
