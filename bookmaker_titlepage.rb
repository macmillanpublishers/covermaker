...
unless gen == false
  ...
  # add the new titlepage to the json file
  data_hash.merge!(epubtitlepage: final_cover)

  finaljson = JSON.generate(data_hash)
  ...
  # add a log to the final dir stating that the titlepage was autogenerated 
  # (this also creates the GEN value for future conversions)
