...
def setFinalCover(oldtitlepage, newtitlepage, logkey='')
...
def decideTitlepageGeneration(titlepagelog, newtitlepage, oldtitlepage, final_cover, logkey='')
...
final_cover = setFinalCover(oldtitlepage, newtitlepage, 'set_final_cover_var')

# Determine whether or not to generate a titlepage.
gen = decideTitlepageGeneration(titlepagelog, newtitlepage, oldtitlepage, final_cover, 'determine_titlepage_generation')
@log_hash['gen(erate_titlepage)_value'] = gen
...
test_jpg_status = titlepageTest(final_cover, 'titlepage_test')
