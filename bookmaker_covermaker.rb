...
def generateCover(coverdir, cover_pdf, pdf_html_contents, pdf_html_file, cover_css_file, testing_value, logkey='')
...
if File.file?(final_cover)
  ...
  # sends file to docraptor for conversion
  generateCover(coverdir, cover_pdf, pdf_html_contents, template_html, cover_css_file, testing_value, 'generate_cover')
  # convert to jpg
